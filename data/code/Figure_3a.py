...
ax2.text(x_positions[2]-2.1, 0.90, 'A', color='k', fontweight='bold', ha='center', va='center', size=12)
ax2.text(x_positions[0]+1.7, 0.195, '5%', color='dimgrey', ha='left', va='bottom', size=6)
ax2.text(x_positions[0]+1.7, 0.39, '95%', color='dimgrey', ha='left', va='top', size=6)
ax2.text(x_positions[0]+1.7, 0.28, 'median', color='dimgrey', ha='left', va='center', size=6)
ax2.text(x_positions[0]+1.7, 0.31, 'mean ± 1σ', color='dimgrey', ha='left', va='center', size=6)

ax2.text(x_positions[0]+1.55, 0.172, 'Glacier area (km$^2$):', color='k', ha='left', va='center', size=6)
...
ax2.legend([handles[0],handles[2],handles[1],handles[3]],
                  ['<1','10-100','1-10','>100'],
                  loc='lower left', ncol=2, columnspacing=1,frameon=False, handlelength=1, bbox_to_anchor=(0.62, -0.025), labelspacing=0.05)
#ax2.legend([handles[0],handles[2],handles[1],handles[3]],
