...
ax1.text(0, 1.008, 'A', fontsize=9, fontweight='bold', transform=ax1.transAxes);
...
ax2.text(0, 1.008, 'B', fontsize=9, fontweight='bold', transform=ax2.transAxes);
...
out_pdf = '/Users/wyan0065/Desktop/AAR-disequilibrium/manuscript/' + 'figure_S12.png'
