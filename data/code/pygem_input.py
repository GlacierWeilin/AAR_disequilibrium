...
model_run_date = 'March 2025'

#%% ===== GLACIER SELECTION =====
rgi_regionsO1 = [19]                 # 1st order region number (RGI V6.0)
rgi_regionsO2 = [1]               # 2nd order region number (RGI V6.0) 
...
ignore_calving = False

#%% ===== OGGM glacier directory filepath =====
oggm_base_url = 'https://cluster.klima.uni-bremen.de/~oggm/gdirs/oggm_v1.6/L3-L5_files/2023.3/elev_bands/W5E5/'
...
gcm_startyear = 2014            # first year of model run (simulation dataset)
gcm_endyear = 2023              # last year of model run (simulation dataset)
...
if rgi_regionsO1[0] in [1,3,4,5,6,7,9,17,19]:
    length_exp = 5000
else:
    length_exp = 2000
...
sim_stat_cns = ['mean', 'std', '2.5%', '25%', 'median', '75%', '97.5%', 'mad']
