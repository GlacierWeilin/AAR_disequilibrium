...
#repub_label = ['Bahr et al.$^{9}$', 'Dyurgerov et al.$^{10}$', 'Mernild et al.$^{12}$', 'Kern and László$^{11}$']
...
## ============== Our study ==============
ax_b.hist(compile_a, density=True, bins = np.linspace(0.1, 3, 40), alpha=1,
...
ax_c.text(0, 1.02, 'C', fontsize=9, fontweight='bold', transform=ax_c.transAxes);
...
ax_c1.axvline(x=region_AAR_mean[0], color='royalblue', linestyle='--', label='Global mean')
...
ax_c2.axhline(y=region_AAR_mean[0], color='royalblue', linestyle='--', label='Global mean')
...
ax_d.text(0, 1.02, 'D', fontsize=9, fontweight='bold', transform=ax_d.transAxes);

## ============== Our study ==============
ax_d.hist(compile_AAR_mean, density=True, bins = np.linspace(0.05, 0.95, 40), alpha=1,
          color='gainsboro', edgecolor='white', linewidth=0.5, orientation='horizontal', label='Histogram');
...
ax_d.plot(compile_AAR_normy, compile_AAR_normx, color='dimgrey', linestyle='-', label='Gaussian DIST')

# Mean and Median
ax_d.axhline(y=np.median(compile_AAR_mean), color='dimgrey', linestyle='--', label='Median')
...
ax_e.text(0, 1.02, 'E', fontsize=9, fontweight='bold', transform=ax_e.transAxes);
...
ax_e1.axvline(x=region_AAR[0], color='royalblue', linestyle='--', label='Global mean')
...
ax_e2.axhline(y=region_AAR[0], color='royalblue', linestyle='--', label='Global mean')
...
ax_f.text(0, 1.02, 'F', fontsize=9, fontweight='bold', transform=ax_f.transAxes);

## ============== Our study ==============
ax_f.hist(compile_AAR, density=True, bins = np.linspace(0.05, 0.95, 40), alpha=1,
          color='gainsboro', edgecolor='white', linewidth=0.5, orientation='horizontal', label='Histogram');
...
ax_f.plot(compile_AAR_normy, compile_AAR_normx, color='dimgrey', linestyle='-', label='Gaussian DIST')

# Mean and Median
ax_f.axhline(y=np.median(compile_AAR), color='dimgrey', linestyle='--', label='Median')
...
out_pdf = '/Users/wyan0065/Desktop/AAR-disequilibrium/manuscript/' + 'figure_S7.png'
