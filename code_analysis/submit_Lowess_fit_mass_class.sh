...
#PBS -N Lowess_fit_mass_class
#PBS -P rd53
#PBS -q normal
#PBS -o ProjSubmit_Lowess_fit_mass_class.outlog
#PBS -e ProjSubmit_Lowess_fit_mass_class.errlog
...
python Lowess_fit_mass_class.py > $Lowess_fit_mass_class.log
