...
#PBS -N Analysis_median_k
#PBS -P rd53
#PBS -q normal
#PBS -o ProjSubmit_Analysis_median_k.outlog
#PBS -e ProjSubmit_Analysis_median_k.errlog
...
python Calculate_regional_mass_median_k.py > $Analysis_median_k.log
