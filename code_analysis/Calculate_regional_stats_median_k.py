...
for region in regions:
    ...
    for i in range(81):
        ...
        # record the results for each glacier
    ...
    result.to_csv(outpath + f'PyGEM_regional_stats_{region:02d}_median_k.csv')

    ds_glacier.to_netcdf(
        outpath + f'PyGEM_glacier_stats_{region:02d}_median_k.nc'
    )
