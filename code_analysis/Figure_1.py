...
ax_a.set_title(r'Area-weighted mean $\boldsymbol{\alpha}$ (related to RGI geometry)',
...
ax_b.set_title(r'Histogram of glacier-level $\boldsymbol{\alpha}$',
...
ax_b.set_xlabel(r'$\alpha$', fontsize=8)
...
ax_c.set_title(r'$\boldsymbol{\alpha}$ under different warming level',
               fontsize=8, fontweight='bold', loc='center', pad=3)
...
ax_c.set_ylabel(r'$\alpha$', fontsize=8)
...
out_pdf = '/Users/wyan0065/Desktop/OGGM/disequilibrium/figures/figure_1.png'
