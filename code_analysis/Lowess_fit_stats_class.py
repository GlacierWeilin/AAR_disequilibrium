...
for cla in ['-1', '1-10', '10-100', '100-']:
    for y_col in lowess_y_cols:
        jobs.append({
            'input_csv': path + f'PyGEM_glacier_stats_area_{cla}_median_a.csv',
            'output_csv': path + f'PyGEM_glacier_stats_area_{cla}_{y_col}_median_a_lowess_fit.csv',
...
for cla in ['land-terminating', 'marine-terminating']:
    for y_col in lowess_y_cols:
        jobs.append({
            'input_csv': path + f'PyGEM_glacier_stats_{cla}_median_a.csv',
            'output_csv': path + f'PyGEM_glacier_stats_{cla}_{y_col}_median_a_lowess_fit.csv',
            'trials_output_csv': None,
            'y_col': y_col,
            'preliminary_num_fits': 500,
            'final_num_fits': 2000,
...
for cla in ['all', 'outAntarc', 'inAntarc']:
    for y_col in lowess_y_cols:
        jobs.append({
            'input_csv': path + f'PyGEM_glacier_stats_MT_{cla}_median_a.csv',
            'output_csv': path + f'PyGEM_glacier_stats_MT_{cla}_{y_col}_median_a_lowess_fit.csv',
            'trials_output_csv': None,
            'y_col': y_col,
            'preliminary_num_fits': 500,
            'final_num_fits': 2000,
...
for cla in ['all', 'outAntarc', 'inAntarc']:
    for y_col in lowess_y_cols:
        jobs.append({
            'input_csv': path + f'PyGEM_glacier_stats_MT_{cla}_median_k.csv',
            'output_csv': path + f'PyGEM_glacier_stats_MT_{cla}_{y_col}_median_k_lowess_fit.csv',
            'trials_output_csv': None,
            'y_col': y_col,
            'preliminary_num_fits': 500,
            'final_num_fits': 2000,
